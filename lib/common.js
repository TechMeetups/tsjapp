...
match_manager =
{
    ...
    // event_match : function (event_id)
    // {
    //     console.log('match_manager.event_match:'+event_id) ;

    //     var companies = Company.find({}).fetch() ;
    //     if(!companies)
    //       return ; 
    ...
    //     {
    //         var jobs = Job.find({company_id: companies[c]._id}).fetch() ; 

    //         IonLoading.show(
    //         {
    //           customTemplate: "Scanning "+jobs.length+' jobs in '+companies[c].name,
    //           duration: 1000
    //         });
    ...
    //         {
    //           match_manager.email_matched(jobs[j]._id,event_id,null,companies[c]._id) ;               
    //         }
    //     }  
    // },
    // company_match : function (event_id,company_id)
    // {
    //     console.log('match_manager.company_match:'+company_id) ;

    //     var jobs = Job.find({}).fetch() ; 
    ...
    //     IonLoading.show(
    //     {
    //       customTemplate: "Scanning "+jobs.length+' jobs...',
    //       duration: 1000
    //     });

    //     for(j=0;j<jobs.length;j++)
    //     {
    //       match_manager.email_matched(jobs[j]._id,event_id,null,company_id) ;               
    //     }
